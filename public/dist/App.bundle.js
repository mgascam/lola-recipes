...
function steps(steps) {
    if (!steps) return;
    var addStep = (0, _bling.$)('#add-step');
    var removeStep = (0, _bling.$)('#remove-step');
    ...
    removeStep.on('click', function (e) {
        e.preventDefault();
        var elements = steps.children.length;
...
var _steps = __webpack_require__(11);
...
(0, _steps2.default)((0, _bling.$)('.steps'));
